...
class EmailRepository:
    ...
    def email_login(self):
        ...
        self._email_server.login(
            self._config.EMAIL_CONFIG["account"],
            self._config.EMAIL_CONFIG["password"],
        )
    ...
    def send_to_email(self, msg):
        try:
            ...
            mime_msg["From"] = self._config.EMAIL_CONFIG["account"]
            ...
            self._email_server.sendmail(
                self._config.EMAIL_CONFIG["account"], msg["recipient"].split(self.EMAIL_SEPARATOR), mime_msg.as_string()
            )
