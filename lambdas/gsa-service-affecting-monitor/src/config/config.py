...
MONITOR_CONFIG = {
    "velo_filter": {host: [] for host in VELOCLOUD_HOSTS},
    "thresholds": {
        ...
        AffectingTroubles.BANDWIDTH_OVER_UTILIZATION: int(
            os.environ["BANDWIDTH_OVER_UTILIZATION_MONITORING_THRESHOLD"]
        ),  # percentage of total bandwidth
        AffectingTroubles.BOUNCING: int(
            os.environ["CIRCUIT_INSTABILITY_MONITORING_THRESHOLD"]
    ...
    "monitoring_minutes_per_trouble": {
        ...
        AffectingTroubles.BANDWIDTH_OVER_UTILIZATION: int(
            os.environ["BANDWIDTH_OVER_UTILIZATION_MONITORING_LOOKUP_INTERVAL"]
        )
        // 60,
