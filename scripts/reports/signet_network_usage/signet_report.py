...
async def process_velo_management_status(csvfile):
    ...
    init_year = 2022
    end_year = 2022
    report_start_date = datetime(year=init_year, month=9, day=1, hour=0, minute=0, second=0, tzinfo=timezone.utc)
    report_end_date = datetime(year=end_year, month=10, day=1, hour=0, minute=0, second=0, tzinfo=timezone.utc)
