...
class CustomerCacheRepository:
    ...
    async def get_cache_for_feedback_process(self):
        orchestrators_filter = self._config.TNBA_FEEDBACK_CONFIG["velo_filter"]

        return await self.get_cache(filter_=orchestrators_filter)
