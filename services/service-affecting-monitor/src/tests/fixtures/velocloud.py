...
from tests.fixtures._helpers import _undefined, velocloudize_date
...
def make_edge():
    def _inner(
        *,
        ...
        enterprise_name: str = "",
        enterprise_id: int = 0,
        enterprise_proxy_id: Optional[int] = _undefined,
        enterprise_proxy_name: Optional[str] = _undefined,
        name: str = "",
        edge_state: str = "",
        system_up_since: str = "",
        service_up_since: str = "",
        last_contact: str = "",
        id_: int = "",
        serial_number: str = "",
        ha_serial_number: Optional[str] = _undefined,
        model_number: str = "",
        latitude: float = 0.0,
        longitude: float = 0.0,
    ):
...
def make_metrics():
    def _inner(
        *,
        ...
        p3_packets_tx: int = 0,
        p3_packets_rx: int = 0,
        control_bytes_tx: int = 0,
        control_bytes_rx: int = 0,
        control_packets_tx: int = 0,
        control_packets_rx: int = 0,
        bps_of_best_path_tx: int = 0,
        bps_of_best_path_rx: int = 0,
        best_jitter_ms_tx: int = 0,
        best_jitter_ms_rx: int = 0,
        best_latency_ms_tx: int = 0,
        best_latency_ms_rx: int = 0,
        best_packet_loss_tx: int = 0,
        best_packet_loss_rx: int = 0,
        score_tx: float = 0.0,
        score_rx: int = 0.0,
...
def make_event():
    def _inner(
        *,
        id_: int = 0,
        event_time: str = velocloudize_date(CURRENT_DATETIME),
        event_type: str = "LINK_DEAD",
        category: str = "",
        severity: str = "",
        message: str = "",
        edge_name: str = "",
        enterprise_username: Optional[str] = "",
