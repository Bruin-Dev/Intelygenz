...
class TestBruinRepository:
    ...
    @pytest.mark.asyncio
    async def get_single_ticket_info_with_service_numbers__404_test(
            self,
            bruin_repository,
            make_rpc_response
    ):
    ...
    async def get_closed_tickets_with_creation_date_limit__ok_test(
        ...
        ticket_response = make_ticket_decamelized(
            ticket_id=1234,
            client_id=5678
        )
    ...
    def _get_status_and_cancellation_reasons_from_notes__cancelled_test(
            self,
            bruin_repository
    ):
        notes = [
    ...
    def _get_status_and_cancellation_reasons_from_notes__cancelled_repeated_reasons_test(
            self,
            bruin_repository
    ):
        notes = [
