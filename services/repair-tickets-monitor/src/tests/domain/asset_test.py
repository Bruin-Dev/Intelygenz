...
class TestAsset:
    def allowed_assets_are_properly_queried_test(self):
        ...
        assets = Assets()
        assets.append(Asset(id=ANY, allowed_topics=[topic_a]))
        assets.append(Asset(id=ANY, allowed_topics=[topic_a, topic_b]))
        assets.append(Asset(id=ANY, allowed_topics=[topic_b]))
        assets.append(Asset(id=ANY, allowed_topics=[topic_b, topic_c]))
