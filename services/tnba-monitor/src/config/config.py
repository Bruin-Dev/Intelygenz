...
MONITOR_CONFIG = {
    ...
    "service_affecting": {
        ...
        "monitoring_minutes_per_trouble": {
            AffectingTroubles.BOUNCING: int(
                os.environ["SERVICE_AFFECTING__CIRCUIT_INSTABILITY_MONITORING_LOOKUP_INTERVAL"]
            )
            // 60,
        },
    },
    ...
    "request_repair_completed_confidence_threshold": int(
        os.environ["MIN_REQUIRED_CONFIDENCE_FOR_REQUEST_AND_REPAIR_COMPLETED_PREDICTIONS"]
    )
    / 100,
}
