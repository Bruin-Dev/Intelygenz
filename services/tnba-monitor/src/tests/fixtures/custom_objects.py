...
def __generate_ticket_object(
    *,
    client_id: int = None,
    ticket_id: int = None,
    ticket_creation_date: str = None,
    ticket_topic: str = None,
    ticket_severity: int = None,
    ticket_creator: str = None,
