...
def __generate_edge(
    *, edge_name: str, is_connected: bool, host: str, enterprise_id: int, edge_id: int, serial_number: str
):
...
def edge_1_connected(host_1, enterprise_id_1, edge_id_1, serial_number_1):
    return __generate_edge(
        edge_name="Big Boss",
        is_connected=True,
        host=host_1,
        enterprise_id=enterprise_id_1,
        edge_id=edge_id_1,
