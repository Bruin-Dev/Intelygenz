...
class TestGetEmails:
    ...
    async def get_unread_emails_ok_test(self, get_emails_action):
        ...
        get_emails_action._email_reader_repository.get_unread_emails.assert_awaited_once_with(email, email_filter)
    ...
    @pytest.mark.asyncio
    async def get_unread_emails_ko_no_email_or_email_filter_test(self, get_emails_action):
        request_id = "123"
        response_topic = "_INBOX.2007314fe0fcb2cdc2a2914c1"
