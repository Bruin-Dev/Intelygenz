...
class TestEmailReaderRepository:
    def instance_test(self, email_reader_repository, email_reader_client, logger):
    ...
    async def mark_as_read_ok_test(self, email_reader_repository):
        ...
        email_reader_repository._email_reader_client.mark_as_read = CoroutineMock(return_value=True)
    ...
    async def mark_as_read_ko_failed_to_mark_test(self, email_reader_repository):
        ...
        email_reader_repository._email_reader_client.mark_as_read = CoroutineMock(return_value=False)
    ...
    async def mark_as_read_ko_no_password_test(self, email_reader_repository):
        ...
        email_reader_repository._email_reader_client.mark_as_read = CoroutineMock()
