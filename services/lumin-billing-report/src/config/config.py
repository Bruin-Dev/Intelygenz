...
BILLING_REPORT_CONFIG = {
    ...
    "timezone": "US/Eastern",
    "date_format": "%m/%d/%Y",
    "fieldnames": ["id", "conversation_id", "type", "host_id", "host_did", "user_did", "timestamp", "fake"],
}

EMAIL_CONFIG = {"sender_email": "mettel.automation@intelygenz.com", "password": os.environ["EMAIL_ACC_PWD"]}
...
QUART_CONFIG = {"title": "lumin-billing-report", "port": 5000}
