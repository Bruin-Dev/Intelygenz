...
class TestPostEmailTag:
    ...
    async def post_email_tag_no_body_test(self):
        ...
        post_email_tag._event_bus.publish_message.assert_awaited_once_with(
    ...
    async def post_email_tag_200_test(self):
        ...
        post_email_tag._bruin_repository.post_email_tag.assert_awaited_once_with(
            email_id, tag_id
        )
        post_email_tag._event_bus.publish_message.assert_awaited_once_with(
            response_topic, msg_published_in_topic
    ...
    async def post_email_tag_status_500_test(self):
        ...
        logger.error.assert_called_once_with(f'Error adding tags to email: Status: 500 body: '
                                             + tags_added_response['body'])
