...
from application.actions.post_email_reply import BRUIN_PATH, PostBody, PostEmailReply
...
class TestPostEmailReply:
    ...
    async def messages_are_properly_handled_test(self, post_email_reply, make_email_reply_message):
        ...
        message = make_email_reply_message(parent_email_id=parent_email_id, reply_body=reply_body)
        ...
        expected_request = BruinPostRequest(
            ...
            body=PostBody(reply_body=reply_body),
        )
...
def make_email_reply_message() -> Callable[..., Dict[str, Any]]:
    def builder(
        ...
        parent_email_id: str = "any_parent_email_id",
