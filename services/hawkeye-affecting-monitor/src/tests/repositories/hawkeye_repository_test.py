...
class TestHawkeyeRepository:
    ...
    @pytest.mark.asyncio
    async def get_tests_results_with_rpc_request_returning_non_2xx_status_test(self, hawkeye_repository, probe_1_uid,
    ...
    @pytest.mark.asyncio
    async def get_tests_results_for_affecting_monitoring_test(self, hawkeye_repository, probe_1_uid, probe_2_uid,
                                                              passed_icmp_test_result_1_on_2020_01_16):
        probe_uids = [
            probe_1_uid,
            probe_2_uid,
