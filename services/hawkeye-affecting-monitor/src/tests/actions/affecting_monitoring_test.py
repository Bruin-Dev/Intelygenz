...
class TestServiceAffectingMonitor:
    ...
    async def start_hawkeye_affecting_monitoring_with_exec_on_start_test(self, affecting_monitor):
        ...
        scheduler.add_job.assert_called_once_with(
            affecting_monitor._affecting_monitoring_process,
            "interval",
    ...
    @pytest.mark.asyncio
    async def affecting_monitoring_process_ok_test(
        self,
        affecting_monitor,
        serial_number_1,
        bruin_client_id,
    ...
    def get_tests_results_sorted_by_date_asc_test(
        self,
        probe_1_uid,
        passed_icmp_test_result_1_on_2020_01_16,
        passed_icmp_test_result_2_on_2020_01_17,
    ...
    def map_cached_devices_with_tests_results_test(
        self, customer_cache, device_cached_info_1, probe_1_uid, tests_results
    ):
        tests_results_by_probe_1_uid = {probe_1_uid: tests_results}
    ...
    async def add_device_to_tickets_mapping_with_resolved_ticket_detail_found_test(
        ...
        affecting_monitor._bruin_repository.get_ticket_details.return_value = ticket_details_response
    ...
    async def add_device_to_tickets_mapping_with_no_affecting_tickets_found_test(
        ...
        expected_tickets_mapping = {serial_number_1: {}}
        assert affecting_monitor._tickets_by_serial == expected_tickets_mapping
    ...
    def find_ticket_detail_by_serial_test(
        self,
        affecting_monitor,
        serial_number_1,
        ticket_detail_in_progress_for_serial_1,
    ...
    def find_ticket_notes_by_serial_test(
        self,
        serial_number_1,
        ticket_note_for_serial_1_posted_on_2020_01_16,
        ticket_note_for_serial_1_posted_on_2020_01_17,
    ...
    def get_notes_sorted_by_date_and_id_asc_test(
        self,
        ticket_note_for_serial_1_posted_on_2020_01_16,
        ticket_note_for_serial_1_posted_on_2020_01_17,
        ticket_note_for_serial_2_posted_on_2020_01_16,
    ...
    async def process_device_test(
        ...
        expected_calls_ordered = [
            call._process_passed_test_result(
                test_result=passed_icmp_test_result_1_on_2020_01_16, device_cached_info=device_cached_info_1
            ),
            call._process_passed_test_result(
                test_result=passed_icmp_test_result_2_on_2020_01_17, device_cached_info=device_cached_info_1
            ),
            call._process_failed_test_result(
                test_result=failed_icmp_test_result_1_on_2020_01_18, device_cached_info=device_cached_info_1
            ),
            call._process_failed_test_result(
                test_result=failed_icmp_test_result_2_on_2020_01_19, device_cached_info=device_cached_info_1
            ),
        ]
    ...
    @pytest.mark.asyncio
    async def append_new_notes_for_device_with_no_notes_to_append_test(
    ...
    async def append_new_notes_for_device_with_notes_to_append_test(
        ...
        notifications_repository = affecting_monitor._notifications_repository
    ...
    def process_passed_test_result_with_no_ticket_found_for_serial_test(
        ...
        tickets_mapping = {serial_number_1: {}}
        affecting_monitor._tickets_by_serial = tickets_mapping
    ...
    def process_passed_test_result_with_passed_note_found_test(
        ...
        ticket_initial_notes = [ticket_initial_note_1]
        ticket_new_notes = [
            {
                "text": note_text_about_failed_icmp_test,
                "date": parse("2020-12-10T13:01:32Z"),
    ...
    def process_passed_test_result_with_failed_note_found_test(
        ...
        ticket_new_notes = [ticket_new_note_1]
        all_ticket_notes = ticket_initial_notes + ticket_new_notes
    ...
    def get_last_note_by_test_type_test(
        self,
        affecting_monitor,
        test_type_network_kpi,
        note_text_about_passed_network_kpi_test,
    ...
    async def process_failed_test_result_with_no_ticket_found_for_serial_and_environment_not_being_production_test(
        self, affecting_monitor, serial_number_1, device_cached_info_1, failed_network_kpi_test_result_2_on_2020_01_23
    ):
    ...
    async def process_failed_test_result_with_no_ticket_found_for_serial_and_successful_ticket_creation_test(
        ...
        device_cached_info_1,
        failed_network_kpi_test_result_2_on_2020_01_23,
        create_affecting_ticket_200_response,
    ):
