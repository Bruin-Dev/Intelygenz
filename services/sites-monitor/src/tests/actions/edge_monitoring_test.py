...
class TestEdgeMonitoring:
    def instance_test(self):
        ...
        edge_monitoring = EdgeMonitoring(
            event_bus, logger, prometheus_repository, scheduler, velocloud_repository, config
        )
    ...
    @pytest.mark.asyncio
    async def process_all_edges_test(
        self,
        instance_server,
        ...
        edge_2_host_1,
        edge_3_host_1,
        serial_number_1_host_1,
        serial_number_2_host_1,
        serial_number_3_host_1,
    ):
        all_links = links_host_1_response["body"]
        response = {"request_id": uuid_, "status": 200, "body": all_links}
        ...
        instance_server._prometheus_repository.set_cycle_total_edges.assert_called_once_with(3)
        instance_server._process_edge.assert_has_awaits(
            [
                call(serial_number_1_host_1, edge_1_host_1),
                call(serial_number_2_host_1, edge_2_host_1),
                call(serial_number_3_host_1, edge_3_host_1),
            ],
            any_order=True,
        )

    @pytest.mark.asyncio
    async def process_all_edges_with_error_test(
        self,
        instance_server,
        links_host_1_response,
        ...
        all_links = (
            links_host_1_response["body"]
            + links_host_2_response["body"]
            + links_host_3_response["body"]
            + links_host_4_response["body"]
        )
        response = {"request_id": uuid_, "status": 400, "body": []}
    ...
    @pytest.mark.asyncio
    async def process_all_edges_with_exception_test(self, instance_server):
        instance_server._velocloud_repository.get_all_links_with_edge_info = CoroutineMock(
    ...
    @pytest.mark.asyncio
    async def process_all_edges_with_cache_test(
        self,
        instance_server,
        links_host_1_response,
        edge_1_host_1,
        ...
        serial_number_2_host_1,
        serial_number_3_host_1,
        serial_number_1_host_2,
    ):
        all_links = links_host_1_response["body"]
        response = {"request_id": uuid_, "status": 200, "body": all_links}

        instance_server._status_cache = {
            serial_number_1_host_1: {"cache_edge": edge_1_host_1},
            serial_number_2_host_1: {"cache_edge": edge_2_host_1},
            serial_number_3_host_1: {"cache_edge": edge_3_host_1},
            serial_number_1_host_2: {"cache_edge": edge_1_host_2},
        }
        instance_server._edges_cache = set(instance_server._status_cache)
        ...
        instance_server._velocloud_repository.get_all_links_with_edge_info.assert_awaited_once()
        instance_server._prometheus_repository.set_cycle_total_edges.assert_called_once_with(3)
        instance_server._prometheus_repository.dec.assert_called_once_with(edge_1_host_2)
        instance_server._process_edge.assert_has_awaits(
            [
                call(serial_number_1_host_1, edge_1_host_1),
                call(serial_number_2_host_1, edge_2_host_1),
    ...
    @pytest.mark.asyncio
    async def process_edge_without_cache_test(self, instance_server, edge_1_host_1, serial_number_1_host_1):
        expected_cache = {serial_number_1_host_1: {"cache_edge": edge_1_host_1}}
        instance_server._prometheus_repository.inc = Mock()
        await instance_server._process_edge(serial_number_1_host_1, edge_1_host_1)
    ...
    @pytest.mark.asyncio
    async def process_edge_with_exception_test(self, instance_server, edge_1_host_1, serial_number_1_host_1):
        expected_cache = {}
    ...
    @pytest.mark.asyncio
    async def process_edge_with_cache_test(self, instance_server, edge_1_host_1, serial_number_1_host_1):
        instance_server._status_cache = {serial_number_1_host_1: {"cache_edge": edge_1_host_1}}
        instance_server._prometheus_repository.inc = Mock()
        await instance_server._process_edge(serial_number_1_host_1, edge_1_host_1)
        instance_server._prometheus_repository.inc.assert_not_called()

    @pytest.mark.asyncio
    async def process_edge_without_cache_edge_no_links_test(
        self, instance_server, serial_number_3_host_1, edge_4_host_1
    ):
        instance_server._status_cache = {serial_number_3_host_1: {"cache_edge": edge_4_host_1}}
        instance_server._prometheus_repository.inc = Mock()
        await instance_server._process_edge(serial_number_3_host_1, edge_4_host_1)
        instance_server._prometheus_repository.inc.assert_not_called()

    @pytest.mark.asyncio
    async def process_edge_with_cache_and_edge_offline_status_test(
        self, instance_server, serial_number_1_host_1, edge_1_host_1, edge_1_host_1_offline
    ):
        instance_server._status_cache = {serial_number_1_host_1: {"cache_edge": edge_1_host_1_offline}}
        instance_server._prometheus_repository.inc = Mock()
        ...
        instance_server._prometheus_repository.inc.assert_not_called()
        instance_server._prometheus_repository.update_edge.assert_called_once_with(edge_1_host_1, edge_1_host_1_offline)

    @pytest.mark.asyncio
    async def process_edge_with_cache_and_link_offline_status_test(
        self, instance_server, serial_number_1_host_1, edge_1_host_1, edge_1_host_1_offline_link
    ):
        instance_server._status_cache = {serial_number_1_host_1: {"cache_edge": edge_1_host_1_offline_link}}
        instance_server._prometheus_repository.inc = Mock()
    ...
    async def start_edge_monitor_job_with_exec_on_start_test(self, instance_server):
        ...
        instance_server._scheduler.add_job.assert_called_once_with(
            instance_server._edge_monitoring_process,
            "interval",
