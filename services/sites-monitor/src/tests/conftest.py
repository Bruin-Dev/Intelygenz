...
@pytest.fixture(scope="function")
def list_all_links_with_edge_info(
    link_1_host_1,
    link_2_host_1,
    link_3_host_1,
    link_4_host_1,
...
def links_host_1_response(link_1_host_1, link_2_host_1, link_3_host_1, link_4_host_1, link_5_host_1):
    return {
        "request_id": "1",
        "status": 200,
        "body": [link_1_host_1, link_2_host_1, link_3_host_1, link_4_host_1, link_5_host_1],
    }


@pytest.fixture(scope="function")
def links_host_2_response(link_1_host_2):
    return {"request_id": "2", "status": 200, "body": [link_1_host_2]}


@pytest.fixture(scope="function")
def links_host_3_response(link_1_host_3):
    return {"request_id": "2", "status": 200, "body": [link_1_host_3]}


@pytest.fixture(scope="function")
def links_host_4_response(link_1_host_4):
    return {"request_id": "4", "status": 200, "body": [link_1_host_4]}


@pytest.fixture(scope="function")
def links_host_4_response_error(link_1_host_4):
    return {"request_id": "4", "status": 300, "body": [link_1_host_4]}
