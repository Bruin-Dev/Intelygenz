...
class TestVelocloudRepository:
    ...
    @pytest.mark.asyncio
    async def get_edges_links_by_host_test(
        self, instance_server, link_1_host_1, link_1_host_2, link_1_host_3, link_1_host_4
    ):
        expected = {"body": [link_1_host_1, link_1_host_2, link_1_host_3, link_1_host_4], "status": 200}
        host = "mettel.host"
        rpc_response_mock = {"body": [link_1_host_1, link_1_host_2, link_1_host_3, link_1_host_4], "status": 200}
        rpc_responses_mock = [rpc_response_mock]
        rpc_request = {
            "request_id": uuid_,
            "body": {"host": host},
        }
    ...
    async def get_edges_links_by_host_with_exception_test(self, instance_server):
        expected = {"body": None, "status": 503}
        host = "mettel.host"

        rpc_responses_mock = [Exception("Failed!"), None]
        rpc_request = {
            "request_id": uuid_,
            "body": {"host": host},
        }
    ...
    async def get_edges_links_by_host_with_nats_error_test(self, instance_server):
        ...
        rpc_responses_mock = [nats_error_response, None]
        rpc_request = {
            "request_id": uuid_,
            "body": {"host": host},
        }
    ...
    @pytest.mark.asyncio
    async def get_all_links_with_edge_info_test(
        self,
        instance_server,
        ...
        expected = {"request_id": uuid_, "status": 200, "body": all_links}
        links_by_host_mock = [
            links_host_1_response,
            links_host_2_response,
            links_host_3_response,
    ...
    @pytest.mark.asyncio
    async def get_all_links_with_edge_info_with_one_error_test(
        self,
        instance_server,
        links_host_1_response,
        links_host_2_response,
        ...
        all_links = links_host_1_response["body"] + links_host_2_response["body"] + links_host_3_response["body"]
        expected = {"request_id": uuid_, "status": 200, "body": all_links}
        links_by_host_mock = [
            links_host_1_response,
            links_host_2_response,
    ...
    def group_links_by_edge_serial_test(
        self,
        instance_server,
        edge_1_host_1,
        edge_2_host_1,
