...
class TestTriage:
    ...
    async def run_tickets_polling_with_customer_cache_ready_test(self):
        ...
        customer_cache = [
            {
                ...
                "bruin_client_info": {"client_id": bruin_client_1, "client_name": "EVIL-CORP"},
            ...
            },
            {
                ...
                "ha_serial_number": None,
                "bruin_client_info": {"client_id": bruin_client_2, "client_name": "EVIL-CORP"},
                "links_configuration": links,
            },
            {
                "edge": edge_3_full_id,
        ...
        triage._get_ticket_details_with_and_without_triage.assert_called_once_with(relevant_tickets_with_notes_filtered)
        triage._process_ticket_details_with_triage.assert_awaited_once_with(ticket_details_with_triage)
        triage._process_ticket_details_without_triage.assert_awaited_once_with(ticket_details_without_triage)
    ...
    async def build_edges_status_by_serial_test(self):
        ...
        customer_cache = [
            {
                ...
                "bruin_client_info": {"client_id": bruin_client_id, "client_name": "EVIL-CORP"},
            },
            {
                "edge": edge_full_id,
                "last_contact": "2020-09-17T02:23:59",
        ...
        triage._cached_info_by_serial = {elem["serial_number"]: elem["edge"] for elem in customer_cache}
    ...
    async def get_all_open_tickets_with_details_for_monitored_companies_test(self):
        ...
        open_tickets_detail_return = [tickets_with_details_for_bruin_client_1, tickets_with_details_for_bruin_client_2]
        ...
        customer_cache = [
            {
                ...
                "serial_number": edge_1_serial,
                "ha_serial_number": None,
                "bruin_client_info": {"client_id": bruin_client_1_id, "client_name": "EVIL-CORP"},
            },
            {
                "edge": edge_2_full_id,
                "last_contact": "2020-09-17T02:23:59",
                "serial_number": edge_2_serial,
                "ha_serial_number": None,
                "bruin_client_info": {"client_id": bruin_client_2_id, "client_name": "EVIL-CORP"},
            },
            {
                "edge": edge_3_full_id,
                "last_contact": "2020-09-17T02:23:59",
        ...
        ticket_ids = [
            {"ticketID": ticket_1_id, "clientID": bruin_client_1_id},
        ...
        triage._get_open_tickets_with_details_by_ticket_id.assert_has_awaits(
            [call(ticket_1_id, []), call(ticket_2_id, [])], any_order=True
        )
    ...
    async def get_all_open_tickets_with_details_for_monitored_companies_with_some_requests_failing_test(self):
        ...
        customer_cache = [
            ...
            },
            {
                ...
                "serial_number": edge_3_serial,
                "ha_serial_number": None,
                "bruin_client_info": {"client_id": bruin_client_3_id, "client_name": "EVIL-CORP"},
            },
        ]
        ...
        bruin_repository.get_open_outage_tickets.assert_awaited_once()
        triage._get_open_tickets_with_details_by_ticket_id.assert_has_awaits(
            [call(ticket_1_id, []), call(ticket_3_id, []), call(ticket_2_id, [])], any_order=True
        )
        ...
        customer_cache = [
            {
                ...
                "ha_serial_number": None,
                "bruin_client_info": {"client_id": 9994, "client_name": "EVIL-CORP"},
            },
            {
    ...
    async def process_ticket_details_with_triage_test(self):
        ...
        triage._was_ticket_note_appended_recently.assert_has_calls(
            [
                call(ticket_detail_1_note_1),
                call(ticket_detail_2_note_3),
            ]
        )
