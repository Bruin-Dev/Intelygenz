...
@pytest.fixture(scope='function')
def triage(event_bus, logger, scheduler, outage_repository, customer_cache_repository, bruin_repository,
           velocloud_repository, notifications_repository, triage_repository, metrics_repository, ha_repository):
    instance = Triage(
        event_bus=event_bus,
        logger=logger,
        scheduler=scheduler,
...
@pytest.fixture(scope='function')
def outage_monitor(event_bus, logger, scheduler, outage_repository, bruin_repository, velocloud_repository,
