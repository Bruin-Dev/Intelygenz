...
class HaRepository:
    ...
    def map_edges_with_ha_info(self, edges_with_links: List[dict], edges_with_ha_info: List[dict]) -> List[dict]:
        ...
        edges_with_links_by_serial = {elem["edgeSerialNumber"]: elem for elem in edges_with_links}
        edges_with_ha_info_by_serial = {elem["serialNumber"]: elem for elem in edges_with_ha_info}
