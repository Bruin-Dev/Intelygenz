...
@pytest.fixture(scope='function')
def api_server_test(logger, new_emails_repository, bruin_repository, new_tickets_repository,
                    notifications_repository, utils_repository):
    return APIServer(logger, config, new_emails_repository, new_tickets_repository,
                     notifications_repository, utils_repository)
