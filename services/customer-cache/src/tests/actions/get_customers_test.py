...
class TestGetCustomers:
    ...
    async def get_customers_200_test(self, instance_get_customer, instance_cache_edges, instance_request_message):
        ...
        instance_get_customer._event_bus.publish_message.assert_awaited_once_with(
            instance_request_message["response_topic"], dict(request_id="1111", body=instance_cache_edges, status=200)
        )
    ...
    async def get_customers_200_enterprise_filter_test(
        ...
        instance_get_customer._event_bus.publish_message.assert_awaited_once_with(
            ...
            dict(request_id="1111", body=[instance_cache_edges[1]], status=200),
        )
    ...
    async def get_customers_202_test(
        ...
        instance_get_customer_with_empty_cache._event_bus.publish_message.assert_awaited_once_with(
            instance_request_message["response_topic"], instance_response_message
        )
