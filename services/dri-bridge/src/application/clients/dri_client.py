...
class DRIClient:
    ...
    async def login(self):
        ...
        try:
            response = await self._session.post(f"{self._config.DRI_CONFIG['base_url']}/auth/login",
    ...
    async def get_pending_task_ids(self, serial_number):
        ...
        try:
            ...
            self._logger.error(f"An error occurred while getting list of pending task ids for "
