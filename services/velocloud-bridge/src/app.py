...
class Container:
    ...
    def __init__(self):
        ...
        self._event_bus.add_consumer(self._subscriber_network_enterprise_edge_list,
        ...
        self._network_enterprise_edge_list = NetworkEnterpriseEdgeList(self._event_bus, self._velocloud_repository,
                                                                       self._logger)
        ...
        self._links_metric_info = ActionWrapper(self._links_metric_info_action, "get_links_metric_info",
                                                is_async=True, logger=self._logger)
        self._list_enterprise_edges = ActionWrapper(self._enterprise_edge_list, "enterprise_edge_list",
                                                    is_async=True, logger=self._logger)
        ...
        self._edge_links_series = ActionWrapper(self._edge_links_series_action, "edge_links_series",
                                                is_async=True, logger=self._logger)
        self._list_network_enterprise_edge = ActionWrapper(self._network_enterprise_edge_list,
                                                           "get_enterprise_edge_list",
                                                           is_async=True, logger=self._logger)
    ...
    async def start(self):
        ...
        await self._event_bus.subscribe_consumer(consumer_name="enterprise_name_list",
                                                 ...
                                                 queue="velocloud_bridge")
        await self._event_bus.subscribe_consumer(consumer_name="enterprise_edge_list",
        ...
        await self._event_bus.subscribe_consumer(consumer_name="edge_links_series",
                                                 ...
                                                 queue="velocloud_bridge")
        await self._event_bus.subscribe_consumer(consumer_name="network_enterprise_edge_list",
