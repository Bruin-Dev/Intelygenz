...
class TestNotificationsRepository:
    ...
    async def get_unread_emails__rpc_request_success_test(
        ...
        notifications_repository._event_bus.rpc_request.assert_awaited_once_with('get.email.request', request,
                                                                                 timeout=90)
    ...
    async def mark_email_as_read__rpc_request_success_test(
        ...
        notifications_repository._event_bus.rpc_request.assert_awaited_once_with('mark.email.read.request', request,
                                                                                 timeout=90)
        assert result == response
    ...
    async def notify_successful_ticket_creation_test(self, notifications_repository):
        ...
        await notifications_repository.notify_successful_ticket_creation(ticket_id=ticket_id,
