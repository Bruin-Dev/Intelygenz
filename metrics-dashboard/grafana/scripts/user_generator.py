...
# TODO
# Hacer la llamada a velocloud bridge para pillar los names de las companies
# Crear un test para esa llamada

# Documentar el nuevo script de usuarios