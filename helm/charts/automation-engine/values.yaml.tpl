...
forticloud-poller:
  enabled: ${FORTICLOUD_POLLER_ENABLED}
  replicaCount: ${FORTICLOUD_POLLER_DESIRED_TASKS}
  config:
    # -- Indicate the capabilities dependencies
    <<: *capabilitiesEnabled
    metrics:
      ...
      #  servicediscovery: true
  image:
    repository: 374050862540.dkr.ecr.us-east-1.amazonaws.com/forticloud-poller
    pullPolicy: Always
    # Overrides the image tag whose default is the chart appVersion.
