...
# -- bouncing-detector-1 subchart specific configuration
bouncing-detector-1:
  enabled: ${BOUNCING_DETECTOR_1_ENABLED}
  replicaCount: ${BOUNCING_DETECTOR_1_DESIRED_TASKS}
  config:
    # -- Papertrail prefix for create logs definition
    papertrail_prefix: "bouncing-detector-1-${BOUNCING_DETECTOR_BUILD_NUMBER}"
  ...
  image:
    repository: 374050862540.dkr.ecr.us-east-1.amazonaws.com/bouncing-detector
    pullPolicy: Always
    # Overrides the image tag whose default is the chart appVersion.
    tag: ${BOUNCING_DETECTOR_BUILD_NUMBER}
  service:
    type: ClusterIP
    port: 5000
  resources:
...
# -- bouncing-detector-2 subchart specific configuration
bouncing-detector-2:
  enabled: ${BOUNCING_DETECTOR_2_ENABLED}
  replicaCount: ${BOUNCING_DETECTOR_2_DESIRED_TASKS}
  config:
    # -- Papertrail prefix for create logs definition
    papertrail_prefix: "bouncing-detector-2-${BOUNCING_DETECTOR_BUILD_NUMBER}"
    # -- Indicate the capabilities dependencies
    <<: *capabilitiesEnabled
    metrics:
      # -- Indicates whether the microservice will expose metrics through prometheus.
...
# -- bouncing-detector-3 subchart specific configuration
bouncing-detector-3:
  enabled: ${BOUNCING_DETECTOR_3_ENABLED}
  replicaCount: ${BOUNCING_DETECTOR_3_DESIRED_TASKS}
  config:
    # -- Papertrail prefix for create logs definition
    papertrail_prefix: "bouncing-detector-3-${BOUNCING_DETECTOR_BUILD_NUMBER}"
    # -- Indicate the capabilities dependencies
    <<: *capabilitiesEnabled
    metrics:
      # -- Indicates whether the microservice will expose metrics through prometheus.
...
# -- bouncing-detector-4 subchart specific configuration
bouncing-detector-4:
  enabled: ${BOUNCING_DETECTOR_4_ENABLED}
  replicaCount: ${BOUNCING_DETECTOR_4_DESIRED_TASKS}
  config:
    # -- Papertrail prefix for create logs definition
    papertrail_prefix: "bouncing-detector-4-${BOUNCING_DETECTOR_BUILD_NUMBER}"
    # -- Indicate the capabilities dependencies
    <<: *capabilitiesEnabled
    metrics:
      # -- Indicates whether the microservice will expose metrics through prometheus.
