...
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/dispatch-portal-frontend"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` | Number of dispatch-portal-frontend pods |
