...
A Helm chart for Kubernetes to deploy microservice notifications-bridge
...
| enabled | bool | `true` | Field to indicate is notifications-bridge is going to be deployed |
...
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/notifications-bridge"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| podAnnotations | object | `{}` |  |
| podSecurityContext | object | `{}` |  |
| replicaCount | int | `1` | Number of notifications-bridge pods |
