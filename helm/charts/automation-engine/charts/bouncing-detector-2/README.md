...
A Helm chart for Kubernetes to deploy microservice bouncing-detector with Velocloud host 2 configuration
...
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` | Number of bouncing-detector-2 pods |
