...
{{- default "ecr-cred-helper" | trunc 63 | trimSuffix "-" }}
{{- end }}
...
*/}}
{{- define "ecr-cred-helper.configmapName" -}}
{{ include "ecr-cred-helper.fullname" . }}-configmap
{{- end }}
...
{{ include "ecr-cred-helper.fullname" . }}-secret
{{- end }}