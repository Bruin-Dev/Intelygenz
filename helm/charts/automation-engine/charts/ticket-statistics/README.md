...
A Helm chart for Kubernetes to deploy microservice ticket-statistics
...
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/ticket-statistics"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` | Number of ticket-statistics pods |
