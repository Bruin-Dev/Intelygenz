...
A Helm chart for Kubernetes to deploy microservice repair-tickets-monitor
...
| global.redis_email_tagger_hostname | string | `"redis"` | Redis Hostname used to store information used by RTA |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/repair-tickets-monitor"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` | Number of repair-tickets-monitor pods |
