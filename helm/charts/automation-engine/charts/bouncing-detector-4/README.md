...
A Helm chart for Kubernetes to deploy microservice bouncing-detector with Velocloud host 4 configuration
...
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` | Number of bouncing-detector-4 pods |
