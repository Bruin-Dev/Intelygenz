...
A Helm chart for Kubernetes to deploy microservice links-metrics-api
...
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/links-metrics-api"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` | Number of links-metrics-api pods |
