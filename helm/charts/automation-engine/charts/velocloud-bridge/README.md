...
| config.velocloud_credentials | string | `""` | Velocloud credentials |
| enabled | bool | `true` |  |
...
| global.nats_server | string | `"nats://nats:4222"` | NATS cluster endpoint used by velocloud-bridge |
...
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/velocloud-bridge"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` |  |
