...
| config.bruin_base_url_ip | string | `""` | IP of Bruin DEV Base URL |
| config.bruin_login_url_ip | string | `""` | IP of Bruin DEV Login URL |
| enabled | bool | `true` |  |
...
| image.repository | string | `"374050862540.dkr.ecr.us-east-1.amazonaws.com/bruin-bridge"` |  |
| image.tag | string | `""` |  |
| nodeSelector | object | `{}` |  |
| replicaCount | int | `1` |  |
