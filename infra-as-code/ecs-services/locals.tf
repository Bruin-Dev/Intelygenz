locals {
  ...
  running_task_count_velocloud-orchestator_alarm-name = "Running tasks count of velocloud-orchestrator service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_bruin-bridge_alarm-name = "Running tasks count of bruin-bridge service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_service-outage-triage_alarm-name = "Running tasks count of service-outage-triage service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_service-affecting-monitor_alarm-name = "Running tasks count of service-affecting-monitor service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_t7-bridge-name = "Running tasks count of t7-bridge service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_notifier-name = "Running tasks count of notifier service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_metrics-grafana-name = "Running tasks count of metrics-grafana service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_metrics-prometheus-name = "Running tasks count of metrics-prometheus service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_service-outage-monitor-name = "Running tasks count of service-outage-monitor service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_last-contact-report-name = "Running tasks count of last-contact-report service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_velocloud-bridge-name = "Running tasks count of velocloud-bridge service in ECS cluster ${var.ENVIRONMENT}"
  running_task_count_nats-server-name = "Running tasks count of nats-server service in ECS cluster ${var.ENVIRONMENT}"
