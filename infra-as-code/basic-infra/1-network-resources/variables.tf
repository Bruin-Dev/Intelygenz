...
variable "DATA_HIGHWAY_AIVEN_PEERING_CONNECTION_ID" {
  type        = string
  description = "VPC PEERING connection ID between data highway aiven and automation nets"
}

variable "AIVEN_CIDR" {
  description = "Aiven CIRD nets blocks"
  default     = "10.1.0.0/24"
}
