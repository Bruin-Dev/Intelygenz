...
| DIGI\_RECORD\_NAME\_DEV | n/a | `string` | `""` | no |
| DIGI\_RECORD\_NAME\_PRO | n/a | `string` | `""` | no |
| DIGI\_RECORD\_NAME\_TEST | n/a | `string` | `""` | no |
...
| hawkeye\_affecting\_monitor\_desired\_tasks | Number of desired tasks of microservice hawkeye-affecting-monitor | `number` | `1` | no |
| hawkeye\_bridge\_desired\_tasks | Number of desired tasks of microservice hawkeye-bridge | `number` | `1` | no |
| hawkeye\_customer\_cache\_desired\_tasks | Number of desired tasks of microservice hawkeye-customer-cache | `number` | `1` | no |
| hawkeye\_outage\_monitor\_desired\_tasks | Number of desired tasks of microservice hawkeye-outage-monitor | `number` | `1` | no |
