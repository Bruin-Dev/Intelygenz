resource "null_resource" "papertrail_provisioning" {
  ...
  depends_on = [
      ...
      aws_ecs_service.automation-digi-bridge,
      aws_ecs_service.automation-digi-reboot-report,
      aws_ecs_service.automation-dispatch-portal-backend,
      aws_ecs_service.automation-dispatch-portal-frontend,
      aws_ecs_service.automation-email-tagger-kre-bridge,
      aws_ecs_service.automation-email-tagger-monitor,
      ...
      aws_ecs_service.automation-queue-forwarder,
