...
resource "aws_ecr_lifecycle_policy" "ticket-statistics-image-untagged-lifecycle" {
...
resource "aws_ecr_lifecycle_policy" "ticket-statistics-image-tagged-lifecycle" {
  repository = aws_ecr_repository.ticket-statistics-repository.name
