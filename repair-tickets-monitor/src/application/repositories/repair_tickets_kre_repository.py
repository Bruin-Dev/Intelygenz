...
class RepairTicketsKRERepository:
    ...
    async def get_prediction(self, email_data: dict):
        ...
        async def get_prediction():
            ...
            try:
                response = await self._event_bus.rpc_request("rta.prediction.request", request_msg,
        ...
        try:
            ...
            self._logger.error(f"Error trying to get prediction from rta KRE [email_id='{email_id}']: {e}")
