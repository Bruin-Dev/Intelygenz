...
class TestEdgeMonitoring:
    ...
    @pytest.mark.asyncio
    async def process_all_edges_test(self, instance_server, links_host_1_response, edge_1_host_1,
                                     edge_2_host_1, edge_3_host_1, serial_number_1_host_1, serial_number_2_host_1,
    ...
    @pytest.mark.asyncio
    async def process_all_edges_with_cache_test(self, instance_server, links_host_1_response, edge_1_host_1,
                                                edge_2_host_1, edge_3_host_1, edge_1_host_2, serial_number_1_host_1,
                                                serial_number_2_host_1, serial_number_3_host_1, serial_number_1_host_2):
        all_links = links_host_1_response['body']
        response = {
            'request_id': uuid_,
            'status': 200,
    ...
    @pytest.mark.asyncio
    async def process_edge_without_cache_edge_no_links_test(self, instance_server, serial_number_3_host_1,
                                                            edge_4_host_1):
        instance_server._status_cache = {
            serial_number_3_host_1: {'cache_edge': edge_4_host_1}
        }
        instance_server._prometheus_repository.inc = Mock()
    ...
    @pytest.mark.asyncio
    async def process_edge_with_cache_and_edge_offline_status_test(self, instance_server, serial_number_1_host_1,
                                                                   edge_1_host_1, edge_1_host_1_offline):
        instance_server._status_cache = {
            serial_number_1_host_1: {'cache_edge': edge_1_host_1_offline}
        }
        instance_server._prometheus_repository.inc = Mock()
    ...
    @pytest.mark.asyncio
    async def process_edge_with_cache_and_link_offline_status_test(self, instance_server, serial_number_1_host_1,
                                                                   edge_1_host_1, edge_1_host_1_offline_link):
        instance_server._status_cache = {
            serial_number_1_host_1: {'cache_edge': edge_1_host_1_offline_link}
        }
        instance_server._prometheus_repository.inc = Mock()
