...
class TestMonitoringMapRepository:
    ...
    #
    #     monitoring_map_repository = MonitoringMapRepository(config, scheduler, event_bus, logger)
    #     monitoring_map_repository._get_bruin_client_info_by_serial = CoroutineMock(return_value=
    #                                                                                bruin_client_info_2_response)
    #
    ...
    #         edge_3_status_response,
    #     ])
    #     monitoring_map_repository._notify_failing_rpc_request_for_edge_status = CoroutineMock()
    #     monitoring_map_repository._get_bruin_client_info_by_serial = CoroutineMock(return_value=
    #                                                                                bruin_client_info_response)
    #
    ...
    #     #     call(edge_1_full_id),
    #     # ])
    #     monitoring_map_repository._get_edge_status_by_id.assert_awaited()
    #     monitoring_map_repository._notify_failing_rpc_request_for_edge_status.assert_awaited_once_with(edge_1_full_id)
    #
    #     expected = {
    #         bruin_client: {
    #             edge_2_serial: {'edge_id': edge_2_full_id, 'edge_status': edge_2_status_with_bruin_client_info},
