...
@pytest.fixture(scope='function')
def ticket_1():
    return {'clientID': 83109, 'clientName': 'RSI', 'ticketID': 5081250, 'category': 'SD-WAN',
            'topic': 'Service Affecting Trouble', 'referenceTicketNumber': 0, 'ticketStatus': 'Closed',
            'address': {'address': '621 Hill Ave', 'city': 'Nashville', 'state': 'TN', 'zip': '37210-4714',
                        'country': 'USA'}, 'createDate': '1/7/2021 8:34:22 PM', 'createdBy': 'Intelygenz Ai',
    ...
    return {
        'ticketDetails': [
            {'detailID': 5583073, 'detailType': 'Repair_WTN', 'detailStatus': 'C', 'detailValue': 'VC05200085762',
             ...
             'lastUpdatedAt': '2021-01-07T17:59:12.523-05:00'}],  # noqa
        'ticketNotes': [{'noteId': 77127141, 'noteValue': '1/7/2021 3:34:01 PM\n', 'serviceNumber': ['VC05200085666'],
                        ...
                        {'noteId': 77128120, 'noteValue': 'Unresolve Action: Holmdel NOC Investigate ',
                         ...
                         'creator': 'api_1@bruin.com'}, {'noteId': 77128126,
...
@pytest.fixture(scope='function')
def ticket_2():
    return {'clientID': 83109, 'clientName': 'RSI', 'ticketID': 5075176, 'category': 'SD-WAN',
            'topic': 'Service Affecting Trouble', 'referenceTicketNumber': 0, 'ticketStatus': 'Closed',
            'address': {'address': '621 Hill Ave', 'city': 'Nashville', 'state': 'TN', 'zip': '37210-4714',
                        'country': 'USA'}, 'createDate': '1/5/2021 9:22:11 PM', 'createdBy': 'Intelygenz Ai',
            'creationNote': None, 'resolveDate': '1/6/2021 10:34:51 PM', 'resolvedby': None, 'closeDate': None,
            'closedBy': None, 'lastUpdate': None, 'updatedBy': None,
            'mostRecentNote': '1/6/2021 1:58:04 PM Intelygenz Ai', 'nextScheduledDate': '1/12/2021 5:00:00 AM',
            'flags': '', 'severity': '3'}  # noqa
    ...
    return {
        'ticketDetails': [
            {'detailID': 5576149, 'detailType': 'Repair_WTN', 'detailStatus': 'C', 'detailValue': 'VC05200085762',
             'assignedToName': '0', 'currentTaskID': None, 'currentTaskName': None, 'lastUpdatedBy': 385677,
             'lastUpdatedAt': '2021-01-06T17:35:10.317-05:00'}],  # noqa
        'ticketNotes': [{'noteId': 77051076, 'noteValue': '1/5/2021 4:22:09 PM\n', 'serviceNumber': ['VC05200085762'],
                        ...
                        {'noteId': 77076710, 'noteValue': 'Unresolve Action: Holmdel NOC Investigate ',
                         ...
                         'creator': 'api_1@bruin.com'}, {'noteId': 77076719,
                                                         ...
                                                         'creator': 'api_1@bruin.com'}, {'noteId': 77076720,
                                                                                         'noteValue': '#*Automation Engine*#\nRe-opening ticket.\n \nEdge Name: TN-NASH-4840-HC-DI \nTrouble: Bandwidth Over Utilization \nInterface: GE1 \nName: Apex 10M (MetTel CID: BBT.113719) \nInterval for Scan: 20 \nScan Time: 2021-01-06 08:57:09.372295-05:00 \nThroughput (Receive): 9196.147 Kbps \nBandwidth (Receive): 9893.0 Kbps \nThreshold (Receive): 80% (7914.4 Kbps) \nLinks:  [Edge|https://metvco03.mettel.net/#!/operator/customer/124/monitor/edge/2044/]  -  [QoE|https://metvco03.mettel.net/#!/operator/customer/124/monitor/edge/2044/qoe/]  -  [Transport|https://metvco03.mettel.net/#!/operator/customer/124/monitor/edge/2044/links/]  \n \n\nTimeStamp: 2021-01-06 08:57:36.651254-05:00',
                                                                                         'serviceNumber': [
                                                                                             'VC05200085762'],
...
@pytest.fixture(scope='function')
def ticket_3():
    return {'clientID': 83109, 'clientName': 'RSI', 'ticketID': 5074441, 'category': 'SD-WAN',
            'topic': 'Service Affecting Trouble', 'referenceTicketNumber': 0, 'ticketStatus': 'Closed',
            'address': {'address': '621 Hill Ave', 'city': 'Nashville', 'state': 'TN', 'zip': '37210-4714',
                        'country': 'USA'}, 'createDate': '1/5/2021 6:49:25 PM', 'createdBy': 'Intelygenz Ai',
            'creationNote': None, 'resolveDate': '1/5/2021 7:34:09 PM', 'resolvedby': None, 'closeDate': None,
            'closedBy': None, 'lastUpdate': None, 'updatedBy': None,
            'mostRecentNote': '1/5/2021 7:33:34 PM Dhruv Patel', 'nextScheduledDate': '1/12/2021 5:00:00 AM',
            'flags': '', 'severity': '3'}  # noqa
    ...
    return {
        'ticketDetails': [
            {'detailID': 5575534, 'detailType': 'Repair_WTN', 'detailStatus': 'C', 'detailValue': 'VC05200085762',
             ...
             'lastUpdatedAt': '2021-01-05T14:34:23.72-05:00'}],  # noqa
        'ticketNotes': [{'noteId': 77043435, 'noteValue': '1/5/2021 1:49:21 PM\n', 'serviceNumber': ['VC05200085762'],
                        ...
                        {'noteId': 77043439,
                         ...
                         'creator': 'api_1@bruin.com'}, {'noteId': 77045257,
                                                         ...
                                                         'creator': 'dpatel@mettel.net'}]  # noqa
    }
...
def filter_ticket_details_3():
    return {
        'ticketDetails': [
            {'detailID': 5575534, 'detailType': 'Repair_WTN', 'detailStatus': 'C',
...
@pytest.fixture(scope='function')
def ticket_4():
    return {'clientID': 83109, 'clientName': 'RSI', 'ticketID': 5073652, 'category': 'SD-WAN',
            'topic': 'Service Affecting Trouble', 'referenceTicketNumber': 0, 'ticketStatus': 'Closed',
            'address': {'address': '621 Hill Ave', 'city': 'Nashville', 'state': 'TN', 'zip': '37210-4714',
                        'country': 'USA'}, 'createDate': '1/5/2021 3:29:39 PM', 'createdBy': 'Intelygenz Ai',
            'creationNote': None, 'resolveDate': '1/5/2021 5:06:54 PM', 'resolvedby': None, 'closeDate': None,
            'closedBy': None, 'lastUpdate': None, 'updatedBy': None,
            'mostRecentNote': '1/5/2021 4:52:05 PM Intelygenz Ai', 'nextScheduledDate': '1/12/2021 5:00:00 AM',
            'flags': '', 'severity': '3'}  # noqa
    ...
    return {
        'ticketDetails': [
            {'detailID': 5574754, 'detailType': 'Repair_WTN', 'detailStatus': 'C', 'detailValue': 'VC05200085762',
             'assignedToName': '0', 'currentTaskID': None, 'currentTaskName': None, 'lastUpdatedBy': 385676,
             'lastUpdatedAt': '2021-01-05T12:07:31.707-05:00'}],  # noqa
...
def ticket_extra_details_details():
    return {
        'ticketDetails': [
            ...
            {'detailID': 5574689, 'detailType': 'Repair_WTN', 'detailStatus': 'C', 'detailValue': 'VC05200089956',
             'assignedToName': '0', 'currentTaskID': None, 'currentTaskName': None, 'lastUpdatedBy': 385676,
             'lastUpdatedAt': '2021-01-05T12:07:31.707-05:00'}],  # noqa
        'ticketNotes': [{'noteId': 77034430, 'noteValue': '1/5/2021 10:29:37 AM\n', 'serviceNumber': ['VC05200085762'],
                         'createdDate': '2021-01-05T10:29:38.857-05:00', 'creator': 'api_1@bruin.com'},
...
def ticket_no_details():
    return {
        'ticketDetails': [
            {'detailID': 5574754, 'detailType': 'Repair_WTN', 'detailStatus': 'C', 'detailValue': 'VC05200089874',
             'assignedToName': '0', 'currentTaskID': None, 'currentTaskName': None, 'lastUpdatedBy': 385676,
             'lastUpdatedAt': '2021-01-05T12:07:31.707-05:00'}, ],  # noqa
        'ticketNotes': [{'noteId': 77034430, 'noteValue': '1/5/2021 10:29:37 AM\n', 'serviceNumber': ['VC05200085762'],
                         'createdDate': '2021-01-05T10:29:38.857-05:00', 'creator': 'api_1@bruin.com'},
...
@pytest.fixture(scope='function')
def customer_cache():
    return [{'edge': {'host': 'mettel.velocloud.net', 'enterprise_id': 100, 'edge_id': 519},
            ...
            {'edge': {'host': 'mettel.velocloud.net', 'enterprise_id': 100, 'edge_id': 951},
             ...
             'logical_ids': [{'interface_name': 'GE1', 'logical_id': '82:b2:34:20:60:fa:0000'},
...
def response_bruin_one_tickets(ticket_1, ticket_extra_details_details):
    return {
        ticket_1['ticketID']: {
            "ticket": ticket_1,
            "ticket_details": ticket_extra_details_details
        },
    }
...
def response_bruin_one_tickets_no_details(ticket_1, ticket_no_details):
    return {
        ticket_1['ticketID']: {
            "ticket": ticket_1,
            "ticket_details": ticket_no_details
        },
    }


@pytest.fixture(scope='function')
def filter_response_bruin_with_all_tickets(ticket_1, filter_ticket_details_1,
                                           ticket_2, filter_ticket_details_2,
                                           ticket_3, filter_ticket_details_3,
                                           ticket_4, filter_ticket_details_4):
    return {
        ticket_1['ticketID']: {
            "ticket": ticket_1,
            "ticket_details": filter_ticket_details_1
        },
        ticket_2['ticketID']: {
            "ticket": ticket_2,
            "ticket_details": filter_ticket_details_2
        },
        ticket_3['ticketID']: {
            "ticket": ticket_3,
            "ticket_details": filter_ticket_details_3
        },
        ticket_4['ticketID']: {
            "ticket": ticket_4,
            "ticket_details": filter_ticket_details_4
        }
    }
