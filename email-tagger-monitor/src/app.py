...
class Container:
    ...
    def __init__(self):
        ...
        self._new_emails_repository = NewEmailsRepository(self._logger, config, self._notifications_repository,
        ...
        self._api_server = APIServer(self._logger, config, self._new_emails_repository,
                                     self._new_tickets_repository, self._notifications_repository,
