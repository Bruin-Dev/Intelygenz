...
class EmailTaggerRepository:
    ...
    async def get_prediction(self, email_data: dict):
        ...
        async def get_prediction():
            ...
            try:
                response = await self._event_bus.rpc_request("email_tagger.prediction.request", request_msg,
    ...
    async def save_metrics(self, email_data: dict, ticket_data: dict):
        ...
        async def save_metrics():
            ...
            try:
                response = await self._event_bus.rpc_request("email_tagger.metrics.request", request_msg,
                                                             timeout=self._timeout)
