...
export TF_VAR_SERVICE_DISPATCH_MONITOR_BUILD_NUMBER=$(cat /tmp/automation-service-dispatch-monitor.json| jq -r .tag)
echo "TF_VAR_SERVICE_DISPATCH_MONITOR_BUILD_NUMBER is ${TF_VAR_SERVICE_DISPATCH_MONITOR_BUILD_NUMBER}"
export TF_VAR_DISPATCH_PORTAL_FRONTEND_BUILD_NUMBER=$(cat /tmp/automation-dispatch-portal-frontend.json| jq -r .tag)
echo "TF_VAR_DISPATCH_PORTAL_FRONTEND_BUILD_NUMBER is ${TF_VAR_DISPATCH_PORTAL_FRONTEND_BUILD_NUMBER}"
export TF_VAR_DISPATCH_PORTAL_FRONTEND_NGINX_BUILD_NUMBER=$(cat /tmp/nginx.json| jq -r .tag)
echo "TF_VAR_DISPATCH_PORTAL_FRONTEND_NGINX_BUILD_NUMBER is ${TF_VAR_DISPATCH_PORTAL_FRONTEND_NGINX_BUILD_NUMBER}"
