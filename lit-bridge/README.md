...
* Outbound message to an endpoint when Dispatch updated:
    * Need to setup this function with 
LITNetworking separately, message rule and endpoint will be needed. 
...
### Request message
```
https://cs66.salesforce.com/services/apexrest/GetDispatch/___DISPATCH_ID___
https://cs66.salesforce.com/services/apexrest/GetDispatch/DIS37290
```
### Response message
```json
{
