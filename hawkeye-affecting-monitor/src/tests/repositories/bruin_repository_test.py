...
class TestBruinRepository:
    ...
    @pytest.mark.asyncio
    async def unresolve_ticket_detail_test(self):
        ticket_id = 12345
        detail_id = 67890
    ...
    @pytest.mark.asyncio
    async def unresolve_ticket_detail_with_rpc_request_failing_test(self):
        ticket_id = 12345
        detail_id = 67890
    ...
    @pytest.mark.asyncio
    async def unresolve_ticket_detail_with_rpc_request_returning_non_2xx_status_test(self):
        ticket_id = 12345
        detail_id = 67890
