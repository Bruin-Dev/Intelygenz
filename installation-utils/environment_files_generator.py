...
SERVICE_OUTAGE__MONITOR__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_OUTAGE_DAY_TIME = parameters['dev']['service-outage']['monitor']['grace-period-to-autoresolve-after-last-documented-outage']
SERVICE_OUTAGE__MONITOR__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_OUTAGE_NIGHT_TIME = parameters['dev']['service-outage']['monitor']['grace-period-to-autoresolve-after-last-documented-outage']
...
env_dict = {
    ...
    os.path.join('services', 'tnba-monitor', 'src', 'config', 'env'): [
        ...
        f'SERVICE_AFFECTING__CIRCUIT_INSTABILITY_MONITORING_THRESHOLD={SERVICE_AFFECTING__MONITOR__CIRCUIT_INSTABILITY_MONITORING_THRESHOLD}',
        ...
        f'SERVICE_AFFECTING__LATENCY_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__LATENCY_MONITORING_LOOKUP_INTERVAL}',
        f'SERVICE_AFFECTING__PACKET_LOSS_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__PACKET_LOSS_MONITORING_LOOKUP_INTERVAL}',
        f'SERVICE_AFFECTING__JITTER_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__JITTER_MONITORING_LOOKUP_INTERVAL}',
    ],
