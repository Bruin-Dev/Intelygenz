...
SERVICE_AFFECTING__MONITOR__MONITORED_VELOCLOUD_HOSTS = json.dumps(json.loads(parameters['dev']['service-affecting']['monitor']['monitored-velocloud-hosts']))
...
SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__RECIPIENTS_PER_CUSTOMER = json.dumps(json.loads(parameters['dev']['service-affecting']['reoccurring-trouble-report']['recipients-per-customer']))
...
SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__ENABLED_CUSTOMERS = json.dumps(json.loads(parameters['dev']['service-affecting']['daily-bandwidth-report']['enabled-customers']))
...
env_dict = {
    ...
    os.path.join('services', 'service-affecting-monitor', 'src', 'config', 'env'): [
        ...
        f'MONITORING__MONITORED_VELOCLOUD_HOSTS={SERVICE_AFFECTING__MONITOR__MONITORED_VELOCLOUD_HOSTS}',
        ...
        f'MONITORING__AUTORESOLVE_DAY_START_HOUR={SERVICE_AFFECTING__MONITOR__AUTORESOLVE_DAY_START_HOUR}',
        f'MONITORING__AUTORESOLVE_DAY_END_HOUR={SERVICE_AFFECTING__MONITOR__AUTORESOLVE_DAY_END_HOUR}',
        ...
        f'REOCCURRING_TROUBLE_REPORT__RECIPIENTS_PER_CUSTOMER={SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__RECIPIENTS_PER_CUSTOMER}',
        ...
        f'DAILY_BANDWIDTH_REPORT__ENABLED_CUSTOMERS={SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__ENABLED_CUSTOMERS}',
