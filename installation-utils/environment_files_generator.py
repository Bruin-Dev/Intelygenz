...
FORTICLOUD__BASE_URL = parameters["dev"]["forticloud-bridge"]["base-url"]
FORTICLOUD__USERNAME = parameters["common"]["forticloud-bridge"]["username"]
FORTICLOUD__PASSWORD = parameters["common"]["forticloud-bridge"]["password"]
FORTICLOUD__CLIENT_ID = parameters["common"]["forticloud-bridge"]["client-id"]
...
env_dict = {
    ...
    os.path.join("services", "forticloud-bridge", "src", "config", "env"): [
        f"ENVIRONMENT_NAME={ENVIRONMENT_NAME}",
        f"NATS_SERVER1={NATS_SERVER1}",
        f"REDIS_HOSTNAME={REDIS_HOSTNAME}",
        f"CURRENT_ENVIRONMENT={CURRENT_ENVIRONMENT}",
        ...
        f"PAPERTRAIL_HOST={PAPERTRAIL_HOST}",
        f"PAPERTRAIL_PORT={PAPERTRAIL_PORT}",
        f"FORTICLOUD_BASE_URL={FORTICLOUD__BASE_URL}",
        f"FORTICLOUD_USERNAME={FORTICLOUD__USERNAME}",
        f"FORTICLOUD_PASSWORD={FORTICLOUD__PASSWORD}",
        f"FORTICLOUD_CLIENT_ID={FORTICLOUD__CLIENT_ID}",
    ],
}
