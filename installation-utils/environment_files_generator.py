...
SERVICE_AFFECTING__MONITOR__AUTORESOLVE_DAY_START_HOUR = parameters['dev']['service-affecting']['monitor']['autoresolve-day-start-hour']
SERVICE_AFFECTING__MONITOR__AUTORESOLVE_DAY_END_HOUR = parameters['dev']['service-affecting']['monitor']['autoresolve-day-end-hour']
...
SERVICE_OUTAGE__MONITOR__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_OUTAGE = parameters['dev']['service-outage']['monitor']['grace-period-to-autoresolve-after-last-documented-outage']
...
for host in SERVICE_OUTAGE__MONITOR__MONITORED_VELOCLOUD_HOSTS:
    ...
    env_dict[os.path.join('services', 'service-outage-monitor', 'src', 'config', filename)] = [
        ...
        f'MONITORING__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_OUTAGE={SERVICE_OUTAGE__MONITOR__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_OUTAGE}',
...
for host in SERVICE_AFFECTING__MONITOR__MONITORED_VELOCLOUD_HOSTS:
    ...
    env_dict[os.path.join('services', 'service-affecting-monitor', 'src', 'config', filename)] = [
        ...
        f'MONITORING__DEFAULT_CONTACT_INFO_PER_CUSTOMER='
        f'{SERVICE_AFFECTING__MONITOR__DEFAULT_CONTACT_INFO_PER_CUSTOMER}\n'
        f'MONITORING__CUSTOMERS_TO_ALWAYS_USE_DEFAULT_CONTACT_INFO='
        f'{SERVICE_AFFECTING__MONITOR__CUSTOMERS_TO_ALWAYS_USE_DEFAULT_CONTACT_INFO}\n'
        ...
        f'MONITORING__BANDWIDTH_OVER_UTILIZATION_MONITORING_THRESHOLD='
        f'{SERVICE_AFFECTING__MONITOR__BANDWIDTH_OVER_UTILIZATION_MONITORING_THRESHOLD}\n'
        f'MONITORING__CIRCUIT_INSTABILITY_MONITORING_THRESHOLD='
        f'{SERVICE_AFFECTING__MONITOR__CIRCUIT_INSTABILITY_MONITORING_THRESHOLD}\n'
        f'MONITORING__CIRCUIT_INSTABILITY_AUTORESOLVE_THRESHOLD='
        f'{SERVICE_AFFECTING__MONITOR__CIRCUIT_INSTABILITY_AUTORESOLVE_THRESHOLD}\n'
        f'MONITORING__LATENCY_MONITORING_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__MONITOR__LATENCY_MONITORING_LOOKUP_INTERVAL}\n'
        f'MONITORING__PACKET_LOSS_MONITORING_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__MONITOR__PACKET_LOSS_MONITORING_LOOKUP_INTERVAL}\n'
        f'MONITORING__JITTER_MONITORING_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__MONITOR__JITTER_MONITORING_LOOKUP_INTERVAL}\n'
        f'MONITORING__BANDWIDTH_OVER_UTILIZATION_MONITORING_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__MONITOR__BANDWIDTH_OVER_UTILIZATION_MONITORING_LOOKUP_INTERVAL}\n'
        f'MONITORING__CIRCUIT_INSTABILITY_MONITORING_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__MONITOR__CIRCUIT_INSTABILITY_MONITORING_LOOKUP_INTERVAL}\n'
        f'MONITORING__AUTORESOLVE_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__MONITOR__AUTORESOLVE_LOOKUP_INTERVAL}\n'
        f'MONITORING__AUTORESOLVE_DAY_START_HOUR='
        f'{SERVICE_AFFECTING__MONITOR__AUTORESOLVE_DAY_START_HOUR}\n'
        f'MONITORING__AUTORESOLVE_DAY_END_HOUR='
        f'{SERVICE_AFFECTING__MONITOR__AUTORESOLVE_DAY_END_HOUR}\n'
        f'MONITORING__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_TROUBLE_DAY_TIME='
        f'{SERVICE_AFFECTING__MONITOR__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_TROUBLE_DAY_TIME}\n'
        f'MONITORING__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_TROUBLE_NIGHT_TIME='
        f'{SERVICE_AFFECTING__MONITOR__GRACE_PERIOD_TO_AUTORESOLVE_AFTER_LAST_DOCUMENTED_TROUBLE_NIGHT_TIME}\n'
        f'MONITORING__MAX_AUTORESOLVES_PER_TICKET='
        f'{SERVICE_AFFECTING__MONITOR__MAX_AUTORESOLVES_PER_TICKET}\n'
        f'MONITORING__CUSTOMERS_WITH_BANDWIDTH_MONITORING_ENABLED='
        f'{SERVICE_AFFECTING__MONITOR__CUSTOMERS_WITH_BANDWIDTH_OVER_UTILIZATION_MONITORING}\n'
        f'MONITORING__LINK_LABELS_BLACKLISTED_IN_ASR_FORWARDS='
        f'{SERVICE_AFFECTING__MONITOR__LINK_LABELS_BLACKLISTED_IN_ASR_FORWARDS}\n'
        f'REOCCURRING_TROUBLE_REPORT__EXECUTION_CRON_EXPRESSION='
        f'{SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__EXECUTION_CRON_EXPRESSION}\n'
        f'REOCCURRING_TROUBLE_REPORT__REPORTED_TROUBLES='
        f'{SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__REPORTED_TROUBLES}\n'
        f'REOCCURRING_TROUBLE_REPORT__TICKETS_LOOKUP_INTERVAL='
        f'{SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__TICKETS_LOOKUP_INTERVAL}\n'
        f'REOCCURRING_TROUBLE_REPORT__REOCCURRING_TROUBLE_TICKETS_THRESHOLD='
        f'{SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__REOCCURRING_TROUBLE_TICKETS_THRESHOLD}\n'
        f'REOCCURRING_TROUBLE_REPORT__DEFAULT_CONTACTS='
        f'{SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__DEFAULT_CONTACTS}\n'
        f'REOCCURRING_TROUBLE_REPORT__RECIPIENTS_PER_HOST_AND_CUSTOMER='
        f'{SERVICE_AFFECTING__REOCCURRING_TROUBLE_REPORT__RECIPIENTS_PER_HOST_AND_CUSTOMER}\n'
        f'DAILY_BANDWIDTH_REPORT__EXECUTION_CRON_EXPRESSION='
        f'{SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__EXECUTION_CRON_EXPRESSION}\n'
        f'DAILY_BANDWIDTH_REPORT__LOOKUP_INTERVAL={SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__LOOKUP_INTERVAL}\n'
        f'DAILY_BANDWIDTH_REPORT__ENABLED_CUSTOMERS_PER_HOST='
        f'{SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__ENABLED_CUSTOMERS_PER_HOST}\n'
