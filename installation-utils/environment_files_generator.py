...
# Bruin Bridge variables
BRUIN_CLIENT_ID = parameters["dev"]["bruin"]["client-id"]
BRUIN_CLIENT_SECRET = parameters["dev"]["bruin"]["client-secret"]
BRUIN_LOGIN_URL = parameters["dev"]["bruin"]["login-url"]
BRUIN_BASE_URL = parameters["dev"]["bruin"]["base-url"]
...
INTERMAPPER_OUTAGE_MONITOR__MAX_EMAILS_TO_RETRIEVE = parameters["common"]["intermapper-outage-monitor"]["max-emails-to-retrieve"]
...
SERVICE_AFFECTING__MONITOR__WIRELESS_LATENCY_MONITORING_THRESHOLD = parameters["common"]["service-affecting"]["monitor"]["wireless-latency-monitoring-threshold"]
SERVICE_AFFECTING__MONITOR__WIRELESS_PACKET_LOSS_MONITORING_THRESHOLD = parameters["common"]["service-affecting"]["monitor"]["wireless-packet-loss-monitoring-threshold"]
SERVICE_AFFECTING__MONITOR__WIRELESS_JITTER_MONITORING_THRESHOLD = parameters["common"]["service-affecting"]["monitor"]["wireless-jitter-monitoring-threshold"]
SERVICE_AFFECTING__MONITOR__WIRELESS_BANDWIDTH_OVER_UTILIZATION_MONITORING_THRESHOLD = parameters["common"]["service-affecting"]["monitor"]["wireless-bandwidth-over-utilization-monitoring-threshold"]
SERVICE_AFFECTING__MONITOR__WIRELESS_CIRCUIT_INSTABILITY_MONITORING_THRESHOLD = parameters["common"]["service-affecting"]["monitor"]["wireless-circuit-instability-monitoring-threshold"]
...
SERVICE_AFFECTING__MONITOR__WIRELESS_LATENCY_MONITORING_LOOKUP_INTERVAL = parameters["common"]["service-affecting"]["monitor"]["wireless-latency-monitoring-lookup-interval"]
SERVICE_AFFECTING__MONITOR__WIRELESS_PACKET_LOSS_MONITORING_LOOKUP_INTERVAL = parameters["common"]["service-affecting"]["monitor"]["wireless-packet-loss-monitoring-lookup-interval"]
SERVICE_AFFECTING__MONITOR__WIRELESS_JITTER_MONITORING_LOOKUP_INTERVAL = parameters["common"]["service-affecting"]["monitor"]["wireless-jitter-monitoring-lookup-interval"]
SERVICE_AFFECTING__MONITOR__WIRELESS_BANDWIDTH_OVER_UTILIZATION_MONITORING_LOOKUP_INTERVAL = parameters["common"]["service-affecting"]["monitor"]["wireless-bandwidth-over-utilization-monitoring-lookup-interval"]
SERVICE_AFFECTING__MONITOR__WIRELESS_CIRCUIT_INSTABILITY_MONITORING_LOOKUP_INTERVAL = parameters["common"]["service-affecting"]["monitor"]["wireless-circuit-instability-monitoring-lookup-interval"]
...
SERVICE_AFFECTING__MONITOR__CUSTOMERS_WITH_BANDWIDTH_OVER_UTILIZATION_MONITORING_DISABLED = json.dumps(json.loads(parameters["common"]["service-affecting"]["monitor"]["customers-with-bandwidth-over-utilization-monitoring-disabled"]))
...
SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__DEFAULT_CONTACTS = json.dumps(json.loads(parameters["common"]["service-affecting"]["daily-bandwidth-report"]["default-contacts"]))
SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__RECIPIENTS_PER_HOST_AND_CUSTOMER = json.dumps(json.loads(parameters["common"]["service-affecting"]["daily-bandwidth-report"]["recipients-per-host-and-customer"]))
...
env_dict = {
    ...
    os.path.join("services", "hawkeye-outage-monitor", "src", "config", "env"): [
        ...
        f"TIMEZONE={TIMEZONE}",
        f"IPA_SYSTEM_USERNAME_IN_BRUIN={IPA_SYSTEM_USERNAME_IN_BRUIN}",
        f"UMBRELLA_HOSTS={UMBRELLA_HOSTS}",
    ...
    os.path.join("services", "intermapper-outage-monitor", "src", "config", "env"): [
        ...
        f"MAX_EMAILS_TO_RETRIEVE={INTERMAPPER_OUTAGE_MONITOR__MAX_EMAILS_TO_RETRIEVE}",
...
for host in SERVICE_AFFECTING__MONITOR__MONITORED_VELOCLOUD_HOSTS:
    ...
    env_dict[os.path.join("services", "service-affecting-monitor", "src", "config", filename)] = [
        ...
        f"MONITORING__WIRELESS_LATENCY_MONITORING_THRESHOLD={SERVICE_AFFECTING__MONITOR__WIRELESS_LATENCY_MONITORING_THRESHOLD}",
        f"MONITORING__WIRELESS_PACKET_LOSS_MONITORING_THRESHOLD={SERVICE_AFFECTING__MONITOR__WIRELESS_PACKET_LOSS_MONITORING_THRESHOLD}",
        f"MONITORING__WIRELESS_JITTER_MONITORING_THRESHOLD={SERVICE_AFFECTING__MONITOR__WIRELESS_JITTER_MONITORING_THRESHOLD}",
        f"MONITORING__WIRELESS_BANDWIDTH_OVER_UTILIZATION_MONITORING_THRESHOLD={SERVICE_AFFECTING__MONITOR__WIRELESS_BANDWIDTH_OVER_UTILIZATION_MONITORING_THRESHOLD}",
        f"MONITORING__WIRELESS_CIRCUIT_INSTABILITY_MONITORING_THRESHOLD={SERVICE_AFFECTING__MONITOR__WIRELESS_CIRCUIT_INSTABILITY_MONITORING_THRESHOLD}",
        ...
        f"MONITORING__WIRELESS_LATENCY_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__WIRELESS_LATENCY_MONITORING_LOOKUP_INTERVAL}",
        f"MONITORING__WIRELESS_PACKET_LOSS_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__WIRELESS_PACKET_LOSS_MONITORING_LOOKUP_INTERVAL}",
        f"MONITORING__WIRELESS_JITTER_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__WIRELESS_JITTER_MONITORING_LOOKUP_INTERVAL}",
        f"MONITORING__WIRELESS_BANDWIDTH_OVER_UTILIZATION_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__WIRELESS_BANDWIDTH_OVER_UTILIZATION_MONITORING_LOOKUP_INTERVAL}",
        f"MONITORING__WIRELESS_CIRCUIT_INSTABILITY_MONITORING_LOOKUP_INTERVAL={SERVICE_AFFECTING__MONITOR__WIRELESS_CIRCUIT_INSTABILITY_MONITORING_LOOKUP_INTERVAL}",
        ...
        f"MONITORING__CUSTOMERS_WITH_BANDWIDTH_MONITORING_DISABLED={SERVICE_AFFECTING__MONITOR__CUSTOMERS_WITH_BANDWIDTH_OVER_UTILIZATION_MONITORING_DISABLED}",
        ...
        f"DAILY_BANDWIDTH_REPORT__DEFAULT_CONTACTS={SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__DEFAULT_CONTACTS}",
        f"DAILY_BANDWIDTH_REPORT__RECIPIENTS_PER_HOST_AND_CUSTOMER={SERVICE_AFFECTING__DAILY_BANDWIDTH_REPORT__RECIPIENTS_PER_HOST_AND_CUSTOMER}",
