...
env_dict = {
    ...
    os.path.join('service-outage-monitor', 'src', 'config', 'env-outage-monitor-1'):
        ...
        f'CURRENT_ENVIRONMENT={CURRENT_ENVIRONMENT}\n'
        f'LAST_CONTACT_RECIPIENT={LAST_CONTACT_RECIPIENT}\n'
        f'VELOCLOUD_HOSTS={SERVICE_OUTAGE_MONITOR_1_VELOCLOUD_HOSTS}\n'
        f'VELOCLOUD_HOSTS_FILTER={SERVICE_OUTAGE_MONITOR_1_VELOCLOUD_HOSTS_FILTER}\n'
    ...
    os.path.join('service-outage-monitor', 'src', 'config', 'env-outage-monitor-2'):
        ...
        f'CURRENT_ENVIRONMENT={CURRENT_ENVIRONMENT}\n'
        f'LAST_CONTACT_RECIPIENT={LAST_CONTACT_RECIPIENT}\n'
        f'VELOCLOUD_HOSTS={SERVICE_OUTAGE_MONITOR_2_VELOCLOUD_HOSTS}\n'
        f'VELOCLOUD_HOSTS_FILTER={SERVICE_OUTAGE_MONITOR_2_VELOCLOUD_HOSTS_FILTER}\n'
        f'ENABLE_TRIAGE_MONITORING=0',
    os.path.join('service-outage-monitor', 'src', 'config', 'env-outage-monitor-3'):
        ...
        f'CURRENT_ENVIRONMENT={CURRENT_ENVIRONMENT}\n'
        f'LAST_CONTACT_RECIPIENT={LAST_CONTACT_RECIPIENT}\n'
        f'VELOCLOUD_HOSTS={SERVICE_OUTAGE_MONITOR_3_VELOCLOUD_HOSTS}\n'
        f'VELOCLOUD_HOSTS_FILTER={SERVICE_OUTAGE_MONITOR_3_VELOCLOUD_HOSTS_FILTER}\n'
        f'ENABLE_TRIAGE_MONITORING=0',
    os.path.join('service-outage-monitor', 'src', 'config', 'env-outage-monitor-4'):
        ...
        f'CURRENT_ENVIRONMENT={CURRENT_ENVIRONMENT}\n'
        f'LAST_CONTACT_RECIPIENT={LAST_CONTACT_RECIPIENT}\n'
        f'VELOCLOUD_HOSTS={SERVICE_OUTAGE_MONITOR_4_VELOCLOUD_HOSTS}\n'
        f'VELOCLOUD_HOSTS_FILTER={SERVICE_OUTAGE_MONITOR_4_VELOCLOUD_HOSTS_FILTER}\n'
        f'ENABLE_TRIAGE_MONITORING=0',
