...
SERVICE_AFFECTING__MONITOR__LINK_LABELS_BLACKLISTED_IN_ASR_FORWARDS = json.dumps(json.loads(parameters["common"]["service-affecting"]["monitor"]["link-labels-blacklisted-in-asr-forwards"]))
SERVICE_AFFECTING__MONITOR__LINK_LABELS_BLACKLISTED_IN_HNOC_FORWARDS = json.dumps(json.loads(parameters["common"]["service-affecting"]["monitor"]["link-labels-blacklisted-in-hnoc-forwards"]))
