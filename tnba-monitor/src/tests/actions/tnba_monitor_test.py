...
class TestTNBAMonitor:
    ...
    @pytest.mark.asyncio
    async def run_tickets_polling_with_customer_cache_ready_and_no_notes_to_append_test(self):
    ...
    async def process_ticket_detail_without_tnba_with_dev_env_test(self):
        ...
        ticket_repository.build_tnba_note_from_prediction.assert_called_once_with(ticket_detail_prediction_1)
        notifications_repository.send_slack_message.assert_awaited_once()
        assert tnba_monitor._tnba_notes_to_append == []

    @pytest.mark.asyncio
    async def process_ticket_detail_without_tnba_with_notes_added_for_append_test(self):
        ticket_id = 12345
        ticket_detail_id = 1
        serial_number = 'VC1234567'
    ...
    @pytest.mark.asyncio
    async def process_ticket_detail_with_tnba_with_notes_added_for_append_test(self):
        ticket_id = 12345
        ticket_detail_id = 1
        ticket_note_1 = {
            "noteId": 41894040,
        ...
        ticket_repository.find_newest_tnba_note_by_service_number.assert_called_once_with(ticket_notes,
                                                                                          serial_number)
        ticket_repository.is_tnba_note_old_enough.assert_called_once_with(ticket_note_1)
        bruin_repository.get_next_results_for_ticket_detail.assert_awaited_once_with(
            ticket_id, ticket_detail_id, serial_number
