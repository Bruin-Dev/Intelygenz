...
CTS_SMS_DISPATCH_TECH_X_HOURS_BEFORE_SMS = """This is an automated message from MetTel.
...
def cts_get_tech_x_hours_before_sms(body):
    return CTS_SMS_DISPATCH_TECH_X_HOURS_BEFORE_SMS.format(
        date_of_dispatch=body.get('date_of_dispatch'),
        hours=body.get('hours')
    )


CTS_SMS_DISPATCH_TECH_X_HOURS_BEFORE_SMS_TECH = """This is an automated message from MetTel.
...
def cts_get_tech_x_hours_before_sms_tech(body):
    return CTS_SMS_DISPATCH_TECH_X_HOURS_BEFORE_SMS_TECH.format(
        date_of_dispatch=body.get('date_of_dispatch'),
        site=body.get('site'),
        street=body.get('street'),
        hours=body.get('hours')
