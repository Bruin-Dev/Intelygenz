...
LIT_SMS_DISPATCH_FIELD_ENGINEER_CONFIRMED = """This is an automated message from MetTel.

A field engineer has been assigned for your location on {date_of_dispatch}.
The field engineer handling this dispatch will be {tech_name}.
"""


def lit_get_dispatch_field_engineer_confirmed_sms(body):
    return LIT_SMS_DISPATCH_FIELD_ENGINEER_CONFIRMED.format(
        date_of_dispatch=body.get('date_of_dispatch'),
