...
A field engineer will arrive in 24 hours, 2019-11-14 @ 6PM-8PM Pacific Time, at your location.

You will receive a text message at this number when they have arrived.
"""


def lit_get_tech_24_hours_before_sms_test():
    body = {
        'date_of_dispatch': '2019-11-14',
        'time_of_dispatch': '6PM-8PM',
        'time_zone': 'Pacific Time'
    }
    tech_24_hours_before_sms = lit_get_tech_24_hours_before_sms(body)
